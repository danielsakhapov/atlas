...
public:
    ...
    void SetArgumentsTable(
        const std::map<std::string, std::string>& args_table)
    {
...
private:
    ...
    bool CheckArgumentValueType(
        const std::string& arg, const std::string& val_type)
    {
